...
public class JobController extends BaseController
{
     ...
     * 查询自动补货任务列表
     */
    @PreAuthorize("@ss.hasPermi('manage:taskJob:list')")
    @GetMapping("/list")
     ...
     * 导出自动补货任务列表
     */
    @PreAuthorize("@ss.hasPermi('manage:taskJob:export')")
     ...
     * 获取自动补货任务详细信息
     */
    @PreAuthorize("@ss.hasPermi('manage:taskJob:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增自动补货任务
     */
    @PreAuthorize("@ss.hasPermi('manage:taskJob:add')")
     ...
     * 修改自动补货任务
     */
    @PreAuthorize("@ss.hasPermi('manage:taskJob:edit')")
     ...
     * 删除自动补货任务
     */
    @PreAuthorize("@ss.hasPermi('manage:taskJob:remove')")
